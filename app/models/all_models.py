...
class Emisor(Base):
    ...
    agente_retencion        = Column(String(8), nullable=True)
    regimen_rimpe           = Column(String(50), nullable=True)
    gran_contribuyente_resolucion = Column(String(50), nullable=True)
